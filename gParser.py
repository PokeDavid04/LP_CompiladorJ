...
def serializedATN():
    return [
        4,1,15,62,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,1,0,3,0,12,8,0,
        1,0,3,0,15,8,0,1,0,5,0,18,8,0,10,0,12,0,21,9,0,1,0,1,0,1,1,1,1,1,
        1,1,1,3,1,29,8,1,1,2,1,2,1,2,1,2,1,2,1,2,4,2,37,8,2,11,2,12,2,38,
        1,2,3,2,42,8,2,1,2,1,2,1,2,5,2,47,8,2,10,2,12,2,50,9,2,1,3,1,3,3,
        3,54,8,3,1,4,1,4,4,4,58,8,4,11,4,12,4,59,1,4,0,1,4,5,0,2,4,6,8,0,
        1,1,0,5,10,66,0,19,1,0,0,0,2,28,1,0,0,0,4,41,1,0,0,0,6,53,1,0,0,
        0,8,55,1,0,0,0,10,12,3,2,1,0,11,10,1,0,0,0,11,12,1,0,0,0,12,14,1,
        0,0,0,13,15,3,8,4,0,14,13,1,0,0,0,14,15,1,0,0,0,15,16,1,0,0,0,16,
        18,5,1,0,0,17,11,1,0,0,0,18,21,1,0,0,0,19,17,1,0,0,0,19,20,1,0,0,
        0,20,22,1,0,0,0,21,19,1,0,0,0,22,23,5,0,0,1,23,1,1,0,0,0,24,25,5,
        12,0,0,25,26,5,2,0,0,26,29,3,4,2,0,27,29,3,4,2,0,28,24,1,0,0,0,28,
        27,1,0,0,0,29,3,1,0,0,0,30,31,6,2,-1,0,31,32,5,3,0,0,32,33,3,4,2,
        0,33,34,5,4,0,0,34,42,1,0,0,0,35,37,3,6,3,0,36,35,1,0,0,0,37,38,
        1,0,0,0,38,36,1,0,0,0,38,39,1,0,0,0,39,42,1,0,0,0,40,42,5,12,0,0,
        41,30,1,0,0,0,41,36,1,0,0,0,41,40,1,0,0,0,42,48,1,0,0,0,43,44,10,
        3,0,0,44,45,7,0,0,0,45,47,3,4,2,3,46,43,1,0,0,0,47,50,1,0,0,0,48,
        46,1,0,0,0,48,49,1,0,0,0,49,5,1,0,0,0,50,48,1,0,0,0,51,54,5,13,0,
        0,52,54,5,14,0,0,53,51,1,0,0,0,53,52,1,0,0,0,54,7,1,0,0,0,55,57,
        5,11,0,0,56,58,5,12,0,0,57,56,1,0,0,0,58,59,1,0,0,0,59,57,1,0,0,
        0,59,60,1,0,0,0,60,9,1,0,0,0,9,11,14,19,28,38,41,48,53,59
    ]
...
class gParser ( Parser ):
    ...
    ruleNames =  [ "root", "statement", "expr", "operand", "comment" ]
    ...
    def root(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 30730) != 0):
                self.state = 11
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & 28680) != 0):
                    self.state = 10
                    self.statement()
